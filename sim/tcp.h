...
private:
    ...
    public:
        ...
        int _debug_srcid = -1;
        int _debug_dstid = -1;
        bool _astrasim_send_finished = false;  // guards multi-fire of flow-finish callback
};
...
private:
    ...
    int _debug_srcid = -1;
    int _debug_dstid = -1;
    bool _astrasim_recv_finished = false;  // guards multi-fire of flow-finish callback
};
